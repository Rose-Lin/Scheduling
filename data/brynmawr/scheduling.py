...
def bmc_reconstruct_time_slots(time_slots):
...
times = bmc_reconstruct_time_slots(times)
time_no_dup = bmc_reconstruct_time_slots(time_no_dup)
pref_dict = parser.bmc_parse_pref(sys.argv[2], hc_classes)
